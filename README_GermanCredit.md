...
**1. Data Understanding and Encoding**
All numerical codes are mapped to descriptive labels for interpretability. No missing values were found in the dataset.

**2. Data Quality Assessment**
Value counts are inspected for each categorical variable. Boxplots are used to identify outliers in numerical variables. No extreme anomalies were detected.
...
**5. Evaluation**
Confusion matrix, accuracy, sensitivity, specificity, precision, recall, F1 score and AUC-ROC.

**6. Goodness of Fit**
Hosmer-Lemeshow test to validate model calibration.
...
2. Place `german_credit.csv` in the project root folder
